...
START_BUTTONS=[
    [
        InlineKeyboardButton('السورس', url='https://t.me/F0FBB'),
        InlineKeyboardButton('قناة البوتات', url='https://t.me/xxxexxex'),
    ],]
...
xrxnr = Client('TikTok', api_id=APP_ID, api_hash=API_HASH, bot_token=BOT_TOKEN)
...
async def _start(bot, update):
  await update.reply_text(f"** مرحبا أنا بوت وضيفتي تحميل من التيكتوك يمكنك تحميل الفيديوهات او المقاطع الصوتية من هنا فقط ارسل رابط المقطع هنا**", True, reply_markup=InlineKeyboardMarkup(START_BUTTONS))
